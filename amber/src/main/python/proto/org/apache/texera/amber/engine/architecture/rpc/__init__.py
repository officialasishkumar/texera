...
class ControlRequest(betterproto.Message):
    ...
    iteration_completed_request: "IterationCompletedRequest" = (
...
class ControllerServiceBase(ServiceBase):
    ...
    async def iteration_completed(
        self, iteration_completed_request: "IterationCompletedRequest"
    ) -> "EmptyReturn":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_iteration_completed(
        self, stream: "grpclib.server.Stream[IterationCompletedRequest, EmptyReturn]"
    ) -> None:
        request = await stream.recv_message()
        response = await self.iteration_completed(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/org.apache.texera.amber.engine.architecture.rpc.ControllerService/IterationCompleted": grpclib.const.Handler(
                self.__rpc_iteration_completed,
                grpclib.const.Cardinality.UNARY_UNARY,
